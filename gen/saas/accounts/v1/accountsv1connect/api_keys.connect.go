...
const (
	...
	APIKeyServiceName = "saas.accounts.v1.APIKeyService"
)
...
const (
	...
	// CreateAPIKey RPC.
	APIKeyServiceCreateAPIKeyProcedure = "/saas.accounts.v1.APIKeyService/CreateAPIKey"
	// APIKeyServiceListAPIKeysProcedure is the fully-qualified name of the APIKeyService's ListAPIKeys
	// RPC.
	APIKeyServiceListAPIKeysProcedure = "/saas.accounts.v1.APIKeyService/ListAPIKeys"
	// APIKeyServiceRevokeAPIKeyProcedure is the fully-qualified name of the APIKeyService's
	// RevokeAPIKey RPC.
	APIKeyServiceRevokeAPIKeyProcedure = "/saas.accounts.v1.APIKeyService/RevokeAPIKey"
	// APIKeyServiceValidateAPIKeyProcedure is the fully-qualified name of the APIKeyService's
	// ValidateAPIKey RPC.
	APIKeyServiceValidateAPIKeyProcedure = "/saas.accounts.v1.APIKeyService/ValidateAPIKey"
)

// APIKeyServiceClient is a client for the saas.accounts.v1.APIKeyService service.
...
// NewAPIKeyServiceClient constructs a client for the saas.accounts.v1.APIKeyService service. By
...
func NewAPIKeyServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) APIKeyServiceClient {
	...
	aPIKeyServiceMethods := v1.File_saas_accounts_v1_api_keys_proto.Services().ByName("APIKeyService").Methods()
...
// CreateAPIKey calls saas.accounts.v1.APIKeyService.CreateAPIKey.
...
// ListAPIKeys calls saas.accounts.v1.APIKeyService.ListAPIKeys.
...
// RevokeAPIKey calls saas.accounts.v1.APIKeyService.RevokeAPIKey.
...
// ValidateAPIKey calls saas.accounts.v1.APIKeyService.ValidateAPIKey.
...
// APIKeyServiceHandler is an implementation of the saas.accounts.v1.APIKeyService service.
...
func NewAPIKeyServiceHandler(svc APIKeyServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/saas.accounts.v1.APIKeyService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAPIKeyServiceHandler) CreateAPIKey(context.Context, *connect.Request[v1.CreateAPIKeyRequest]) (*connect.Response[v1.CreateAPIKeyResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("saas.accounts.v1.APIKeyService.CreateAPIKey is not implemented"))
}
...
func (UnimplementedAPIKeyServiceHandler) ListAPIKeys(context.Context, *connect.Request[v1.ListAPIKeysRequest]) (*connect.Response[v1.ListAPIKeysResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("saas.accounts.v1.APIKeyService.ListAPIKeys is not implemented"))
}
...
func (UnimplementedAPIKeyServiceHandler) RevokeAPIKey(context.Context, *connect.Request[v1.RevokeAPIKeyRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("saas.accounts.v1.APIKeyService.RevokeAPIKey is not implemented"))
}
...
func (UnimplementedAPIKeyServiceHandler) ValidateAPIKey(context.Context, *connect.Request[v1.ValidateAPIKeyRequest]) (*connect.Response[v1.ValidateAPIKeyResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("saas.accounts.v1.APIKeyService.ValidateAPIKey is not implemented"))
}
