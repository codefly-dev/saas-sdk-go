...
const file_saas_accounts_v1_user_settings_proto_rawDesc = "" +
	...
	"\x15THEME_PREFERENCE_DARK\x10\x032\xbf\x02\n" +
	"\x13UserSettingsService\x12\x82\x01\n" +
	"\x03Get\x12(.saas.accounts.v1.GetUserSettingsRequest\x1a\x1e.saas.accounts.v1.UserSettings\"1\xc2\xf3\x18\x14\b\x02\x10\x020\x01:\x02\x10\x01@\x01H\x03P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\x13\x12\x11/v1/user/settings\x12\xa2\x01\n" +
	"\x06Update\x12+.saas.accounts.v1.UpdateUserSettingsRequest\x1a\x1e.saas.accounts.v1.UserSettings\"K\xc2\xf3\x18+\b\x02\x10\x020\x01:\x19\n" +
	"\x15saas.settings.updated\x10\x02@\x01H\x04P\x03X\x03`\x01\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11/v1/user/settingsB\xcf\x01\n" +
