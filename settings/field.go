// Package settings is the schema-agnostic runtime for protobuf-backed typed
// settings. It gives a module or product typed, presence-aware access to a
// generated settings message without traversing protobuf parents or addressing
// JSON keys by hand.
//
...
// handled by JSONCodec. The runtime imports no generated schema, so every
// module depends on this package rather than vendoring a copy.
package settings
